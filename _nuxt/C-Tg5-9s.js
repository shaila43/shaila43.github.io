import{_ as g}from"./ChXfpoHm.js";import{g as x}from"./Bqydwg0p.js";import{j as w,k as h,c as l,o as d,a as t,l as u,b as n,w as i,d as a,p as f,m as k}from"#entry";const y={class:"relative text-sm"},b={key:0,class:"material-icons-outlined !text-lg"},v={key:1,class:"material-icons-outlined !text-lg"},_=["innerHTML"],$={__name:"CodeWithCopy",props:{code:{type:String,required:!0},lang:{type:String,required:!0}},async setup(p){let o,e;const r=p,s=w(!1),c=()=>{navigator.clipboard.writeText(r.code).then(()=>{s.value=!0,setTimeout(()=>{s.value=!1},2e3)})},m=([o,e]=h(()=>x()),o=await o,e(),o).highlight(r.code,{lang:r.lang});return(P,R)=>(d(),l("div",y,[t("button",{class:"absolute right-2 top-2 bg-gray-600 text-white px-2 rounded-md cursor-pointer py-2 flex items-center justify-center h-8 w-8","aria-label":"Copy code snippet to clipboard",onClick:c},[u(s)?(d(),l("span",b,"check")):(d(),l("span",v,"content_copy"))]),t("div",{class:"p-4 bg-[#272822] rounded-md overflow-auto",innerHTML:u(m)},null,8,_)]))}},S={class:"max-w-3xl mx-auto mt-12"},C={__name:"ScrollOrBack",setup(p){const o=()=>window.scrollTo({top:0,behavior:"smooth"});return(e,r)=>{const s=g;return d(),l("nav",S,[n(s,{to:"/",class:"inline-block text-white py-2 px-4 bg-gradient-brand text-center shadow"},{default:i(()=>[...r[0]||(r[0]=[a(" Back to list ",-1)])]),_:1}),t("button",{onClick:o,class:"fixed right-4 bottom-4 w-12 h-12 rounded-full bg-gradient-brand text-white flex items-center justify-center shadow-lg z-50 cursor-pointer","aria-label":"Back to top"},[...r[1]||(r[1]=[t("span",{class:"material-icons-outlined"},"expand_less",-1)])])])}}},q=f("/img/how-to-implement-siwe.webp"),M={class:"max-w-3xl mx-auto"},I={class:"space-y-4 md:space-y-6"},E={class:"text-lg/relaxed text-neutral-700"},T={class:"text-lg/relaxed text-neutral-700"},A={class:"text-lg/relaxed text-neutral-700 list-disc ml-10 space-y-3 marker:text-gray-300"},j=`import { BrowserProvider, getAddress } from "ethers";
...
});`,lang:"php"}),e[14]||(e[14]=t("p",{class:"text-lg/relaxed text-neutral-700"}," Create controller with required methods. ",-1)),n(s,{code:W,lang:"php"}),e[15]||(e[15]=t("p",{class:"text-lg/relaxed text-neutral-700"}," Nonce is a unique, one-time code that prevents replay attacks. Each login gets a fresh nonce that expires in 5 minutes and can't be reused. ",-1)),e[16]||(e[16]=t("p",{class:"text-lg/relaxed text-neutral-700"}," On frontend side prepare onClick onSignInWithMetamask function. ",-1)),n(s,{code:j,lang:"js"}),e[17]||(e[17]=t("p",{class:"text-lg/relaxed text-neutral-700"}," After verification user token could be saved and used in subsequent requests. ",-1)),e[18]||(e[18]=t("p",{class:"text-lg/relaxed text-neutral-700"},"Useful links:",-1)),t("ul",A,[t("li",null,[n(r,{href:"https://eips.ethereum.org/EIPS/eip-4361",target:"_blank",class:"link-primary"},{default:i(()=>[...e[8]||(e[8]=[a("EIP-4361 specification",-1)])]),_:1})])])])]),n(c)])}}};export{O as default};
